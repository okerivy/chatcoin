...
typedef NS_ENUM(NSInteger, LLMessageBodyType) {
    ...
    kLLMessageBodyTypeImage ,
    kLLMessageBodyTypeVideo ,
    kLLMessageBodyTypeVoice ,
    kLLMessageBodyTypeEMLocation ,
    kLLMessageBodyTypeFile ,
...
typedef NS_ENUM(NSInteger, LLMessageStatus) {
    kLLMessageStatusPending  = 0,    /*! \~chinese 发送未开始 \~english Pending */
    kLLMessageStatusDelivering,      /*! \~chinese 正在发送 \~english Delivering */
    kLLMessageStatusSuccessed,       /*! \~chinese 发送成功 \~english Successed */
    kLLMessageStatusFailed,          /*! \~chinese 发送失败 \~english Failed */
