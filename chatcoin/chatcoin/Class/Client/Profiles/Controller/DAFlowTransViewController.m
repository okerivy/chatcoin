...
@interface DAFlowTransViewController ()
<UITextFieldDelegate>
...
@implementation DAFlowTransViewController
...
- (void)balanceViewInit
{
    ...
    UILabel *accountLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, 200, ViewHeight)];
    accountLabel.text = @"一小时失效";
    accountLabel.font = [UIFont systemFontOfSize:18];
    
    [_balanceView addSubview:accountLabel];
    
    NSString *moneyLabelStr = @"88989";
...
- (void)bigViewInit
{
    ...
    [_qcodeBtn setImage:[UIImage imageNamed:@"转账-成功"] forState:UIControlStateNormal];
    ...
    [_peopleBtn setImage:[UIImage imageNamed:@"转账-进行中"] forState:UIControlStateNormal];
    ...
    self.moneyTextF = [self cusTextFiledWithFrame:CGRectMake(addrTextFX, ViewHeight + 1, 230, ViewHeight) placeholder:@"最多 8888"];
